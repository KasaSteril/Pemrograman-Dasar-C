...
int main() {
    ...
    switch (pilihanFilm) {
        case 1: totalHarga = Spiderman; break;
        case 2: totalHarga = Batman; break;
        case 3: totalHarga = Superman; break;
        case 4: totalHarga = Avengers; break;
        case 5: totalHarga = Joker; break;
        default:
    ...
    switch (pilihanTiket) {
        case 1: totalHarga += Reguler; break;
        case 2: totalHarga += VIP; break;
        case 3: totalHarga += VVIP; break;
        default:
